...
describe("LoginPage", () => {
  ...
  it("should toggle to the register form and create an account (register path)", async () => {
    ...
    await user.click(screen.getByRole("button", { name: /create an account|register|sign up/i }));
  ...
  it("should show a loading state while the request is in flight (intentional loading)", async () => {
    ...
    expect(screen.getByRole("status")).toHaveTextContent(/signing in|please wait|loading/i);
